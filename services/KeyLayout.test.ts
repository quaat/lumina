...
describe('KeyLayout Aspect Ratio', () => {
    ...
    it('should favor width-driven sizing when keys fit vertically', () => {
    ...
    it('should switch to height-driven sizing when keys are too few (zoomed in)', () => {
    ...
    it('black keys should scale proportionally', () => {
    ...
    it('getNoteX should return absolute coordinates including offsets', () => {
        const layout = new KeyLayout(WIDTH, HEIGHT, 60, 71);
        // First key is C4 (60).
